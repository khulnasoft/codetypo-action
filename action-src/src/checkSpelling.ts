...
import type { RunResult } from 'codetypo';
...
import { CodeTypoReporterForGithubAction } from './reporter.js';
...
async function checkSpelling(
    ...
    const collector = new CodeTypoReporterForGithubAction(params.inline, reporterOptions, core);
